...
\begin{document}
    ...
    Dado que el número de mulas m es un parámetro variable de entrada, el problema del Transporte Discreto generaliza el problema de Multi-Way Number Partitioning. Este último ha sido demostrado como APX-hard, lo que implica que existe un factor de aproximación constante por debajo del cual es imposible descender en tiempo polinomial (a menos que P=NP). Por lo tanto, no es posible diseñar un PTAS que garantice una solución (1+ε) para cualquier m y ε en tiempo polinomial.
